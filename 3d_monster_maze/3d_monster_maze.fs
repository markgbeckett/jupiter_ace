...
: TEST
    11 3 0 ( STARTING POSITION FOR TEST )

    BEGIN
	CLS ( OR FRAMECLEAR )

	3DUP DRAWVIEW ( FRAMEUPDATE )
	0 22 AT .S
...
CODE FRAMECLEAR
    #21 C,  XX C,  XX C, ( LD HL, BUFFER+#02BF )
    #3E C, #20 C,        ( LD A, 'SPACE' )  
    #77 C,               ( LD <HL>, A )
    #11 C,  XX C,  XX C, ( LD DE, BUFFER+#02BE )
    #01 C, #BF C, #02 C, ( LD BC, #02BF )
    #ED C, #B8 C,        ( LDDR )
    #FD C, #E9 C,        ( JP IY )

CODE FRAMEUPDATE
    #21 C,  XX C,  XX C, ( LD HL, BUFFER )
    #11 C, #00 C, #24 C, ( LD DE, #2400 )
    #01 C, #00 C, #2C C, ( LD BC, #02C0 )
    #ED C, #B0 C,        ( LDIR )
    #FD C, #E9 C,        ( JP IY )
