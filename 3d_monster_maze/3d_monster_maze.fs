...
( ON A 50 HZ COMPUTER, THERE ARE 1250 GETKEY WAITS FOR 1 SEC )
: GETKEY ( ITER -- )
    DO
	INKEY
...
: MAKEPASSAGE ( X Y DIR LEN -- NX NY )
	...
	( DECREMENT LENGTH AND CHECK IF DONE )
	1-
	DUP
    0= UNTIL
...
: PLAYMAZE
	...
	PLMOVED @ IF
	    ...
	    0 PLMOVED !
	ELSE
	    50 GETKEY ( ARTIFICIAL WAIT TO MAKE TIMING MORE CONSISTENT )
	THEN
...
: 3DMM
	...
	18 2 AT ." ZX81 VERSION M.E.EVANS 1981"
	19 3 AT ." ACE VERSION G.BECKETT 2022"
