...
CODE FRAMEGRAB
    #21 C, #24 C, #00 C, ( LD HL, #2400 )
    #11 C, #76 C, #3C C, ( LD DE, BUFFER )
    #01 C, #C0 C, #02 C, ( LD BC, #02C0 )
    #ED C, #B0 C,        ( LDIR )
    #FD C, #E9 C,        ( JP IY )
...
CODE FTYPE
    #CD C, #4E C, #08 C, ( CALL #084E )
    #DF C,               ( RST #18 )
    #21 C, #ED C, #3D C, ( LD HL, 3D2D )
    #78 C,               ( LD A,C ) 
    #B1 C,               ( OR C )
    #28 C, #07 C,        ( JR Z, +07 )
    #1A C,               ( LD A,<DE> )
...
: TEST
    1 [ 3DVIEW 12 + ] LITERAL CALL ( CLEAR FRAME BUFFER )
	...
	1+ ?DUP IF
	    ...
	    CYCLEPAT
	    [ 3DVIEW 15 + ] LITERAL CALL ( PUSH TO DISPLAY )
	THEN
...
: MOVEREXEW ( DC -- )
	...
	0 [ 3DVIEW 21 + ] LITERAL C! ( RESET STEP TIMER )
    THEN
;
