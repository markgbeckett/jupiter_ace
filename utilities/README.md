...
- [zx_printer_zxf4.wav](zx_printer_zxf4.wav) - a small selection of words that enhance Tree Forth's ZX Printer support.

- [clock_zxf4.wav](clock_zxf4.wav) - a version of the clock demonstration, from the Tree Forth manual, but updated for PAL-based, 50 Hz systems. This demonstrator depends on [zx_printer_zxf4.wav](zx_printer_zxf4.wav).

- [Guidance on loading software from WAV files](loading_from_tape.md).
