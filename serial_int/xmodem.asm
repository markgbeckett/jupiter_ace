...
CTRL_PORT:	equ 0x80	; Based on 6850 serial module
DATA_PORT:	equ 0x81
...
w_sreset:
	...
	ld a, RESET
	out (CTRL_PORT),a	; Send reset signal to serial device
...
.word_end:
	...
	;; ========================================================
	;; Forth word to attempt to receive a byte from serial
	;; interface
	;;
	;; On entry:
	;;   --
...
.word_end:
	...
	;; ========================================================
	;; Forth word to send a byte to serial interface
	;;
	;; On entry:
	;;   TOS	- byte to be sent
	;;
